...
import com.mall.b2bp.services.order.OrderReturnEntryService;
...
public class OrderReturnServiceImplFromEmarket implements OrderReturnService {

	private static final Logger LOG = LoggerFactory
			.getLogger(OrderReturnServiceImplFromEmarket.class);
	...
	@Resource(name = "orderReturnEntryService")
	...
	@Override
	public List<OrderReturnVo> selectByOrderId(String orderId) throws ServiceException {
...
//		try {
//			List<OrderReturnModel> list = orderReturnModelMapper.selectByOrderId(vo);
...
//		return voList;
		...
		//设置uri
//		StringBuffer uri =new StringBuffer("http://192.168.1.62:9101/emarketplacewebservices/v2/electronics/orders/detail/");
//		StringBuffer uri =new StringBuffer(ResourceUtil.getSystemConfig().getProperty("url_emarket_webservice"));
		...
		try {
			...
			// OrderWsDTO result = 
					 restTemplate.getForObject(uri.toString(), OrderWsDTO.class);
			 
//			 System.out.println(result);
			
//			 List<OrderEntryWsDTO>  orderEntryList= result.getEntries();
//			 if(orderEntryList != null){
//				 for(OrderEntryWsDTO orderEntry : orderEntryList){
